                ...
                if (req.method === 'GET') {
                    ...
                    if (req.url.startsWith('/api/habits')) {
                        if (urlBase.endsWith('/check-in')) {
                            ...
                            if (index !== -1)
                                mockHabits[index] = { ...mockHabits[index], ...parsed };
                        ...
                        if (req.method === 'POST') {
                            ...
                            if (index !== -1)
                                mockReminders[index] = { ...mockReminders[index], ...parsed };
    ...
    plugins: [
        ...
        ...(process.env.NODE_ENV !== "production" && process.env.REPL_ID !== undefined
            ? [
                ...
                import("@replit/vite-plugin-cartographer").then((m) => m.cartographer({ root: path.resolve(import.meta.dirname, "..") })),
