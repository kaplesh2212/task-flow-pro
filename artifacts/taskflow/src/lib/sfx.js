...
export const sfx = {
    click: () => playNotes([{ freq: 660, duration: 0.06, type: "triangle", gain: 0.05 }]),
    taskComplete: () => playNotes([
    ...
    pop: () => playNotes([{ freq: 800, duration: 0.05, type: "square", gain: 0.06 }]),
    panicAlert: () => {
